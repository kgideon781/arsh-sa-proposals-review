...
const App = () => {
    ...
    const stats = useMemo(() => {
        ...
        return { total, totalReviews, ...recommendations, avgScore };
    }, [groupedData]);
    ...
    const exportToExcel = () => {
        try {
            ...
            ws['!cols'] = [
                { wch: 30 }, { wch: 10 }, { wch: 25 }, { wch: 30 }, { wch: 15 },
                        ...
                        <div className="flex gap-3">
                            ...
                            {Object.keys(groupedData).length > 0 && (
                                <button
                                    ...
                                    disabled={!xlsxLoaded}
                                    className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-6 py-3 rounded-xl transition-all shadow-md hover:shadow-lg disabled:opacity-50"
                                >
